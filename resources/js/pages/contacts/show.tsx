                            ...
                            <TooltipProvider delayDuration={150}>
                                ...
                                <thead>
                                    <tr className="border-b border-sidebar-border/70 text-left font-medium">
                                        ...
                                        <th className="sticky top-0 z-20 w-32 bg-muted/40 px-4 py-3 text-muted-foreground backdrop-blur supports-backdrop-filter:bg-muted/30">
                                            Date
                                        </th>
                                        ...
                                        <th className="sticky top-0 z-20 w-28 bg-muted/40 px-4 py-3 text-muted-foreground backdrop-blur supports-backdrop-filter:bg-muted/30">
                                            Type
                                        </th>
                                        <th className="sticky top-0 z-20 w-40 bg-muted/40 px-4 py-3 text-muted-foreground backdrop-blur supports-backdrop-filter:bg-muted/30">
                                            Source
                                        </th>
                                        <th className="sticky top-0 z-20 w-48 bg-muted/40 px-4 py-3 text-muted-foreground backdrop-blur supports-backdrop-filter:bg-muted/30">
                                            Category
                                        </th>
                                        ...
                                        <th className="sticky top-0 z-20 w-24 bg-muted/40 px-4 py-3 text-right text-muted-foreground backdrop-blur supports-backdrop-filter:bg-muted/30">
                                            Actions
                                        </th>
                                    </tr>
                                </thead>
